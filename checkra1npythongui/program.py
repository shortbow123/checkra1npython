...
def homeScreen():
    ...
    kahootButton = pg.Rect(260, 36, 200, 200)
    ...
    rcmText = mainFont.render("Coming Soon", True, white)
    #"RCM payloads"
    kahootText = mainFont.render("Coming Soon", False, white)
    #"Kahoot Spammer"
    ...
    pg.draw.rect(screen, darkGrey, kahootButton)
    ...
    screen.blit(kahootText, (280, 125))
...
while running:
    ...
    if curScreen == 0 and checkra1nButton.collidepoint(mousePosition) and mouseButton > (0, 0, 0):
        ...
        screens.rcmLoader()
        homeScreen()
    elif curScreen == 0 and kahootButton.collidepoint(mousePosition) and mouseButton > (0, 0, 0):
        print("switching to kahoot spammer")
        screen.fill(black)
        time.sleep(0.1)
        screens.kahoot()
        homeScreen()
